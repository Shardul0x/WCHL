...
export const canisterId = process.env.CANISTER_ID_CREATIVE_VAULT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./creative_vault_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the creative_vault_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./creative_vault_frontend.did.js")._SERVICE>}
 */
export const creative_vault_frontend = createActor(canisterId);
